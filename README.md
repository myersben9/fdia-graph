...
**New here?** [`docs/DATA_DICTIONARY.md`](docs/DATA_DICTIONARY.md) — what every array means · [`docs/CONCEPTS_TO_CODE.md`](docs/CONCEPTS_TO_CODE.md) — paper equations → functions · [`docs/EXAMPLES.md`](docs/EXAMPLES.md) — runnable baselines, streams, stats.
