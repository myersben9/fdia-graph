...
| series admittance | `formulas.network.series_admittance`; *today* also inline in `engine.core.FdiaGenerator.__init__` (step 5) | y_s = 1 / (r + jx), zero when the branch has no impedance | [MP19, branch model] | the static edge physics |
