...
| `VALIDATION_PLAN.md` | **proposed**: every input check declared on a data model and enforced by one engine; dataset capabilities in one table; the six-step series |
